function TechDiversityGender() {
  ...
  this.femaleColour = color(199, 74, 60);
  this.maleColour = color(74, 76, 158);
  ...
  this.draw = function () {
    ...
    for (var i = 0; i < this.data.getRowCount(); i++) {
      ...
      var company = {
        ...
        name: this.data.getRow(i).getString(0),
        female: this.data.getRow(i).getNum(1),
        male: this.data.getRow(i).getNum(2),
      };
